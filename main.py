...
observation_states = ['motivated',
                      'burned-out']  # A graduate student's mental health observed after a rotation
...
# np.alltrue(use_case_decoded_hidden_states == use_case_one_data['hidden_states'])
...
# observation and hidden states and prior, transition, and emission probabilities.
print(prog_cm_data['prior_probabilities'], "prior")
print(prog_cm_data['transition_probabilities'], "transition")
print(prog_cm_data[
                                           'emission_probabilities'], "emission")
print(prog_cm_data['observation_states'], 'obs')
...
print(prog_cm_data['hidden_states'], "actual hidden states")
print(evaluate_viterbi_decoder_using_observation_states_of_prog_cm, "pred hidden states")
print(np.sum(prog_cm_data['hidden_states'] ==
        evaluate_viterbi_decoder_using_observation_states_of_prog_cm) / len(prog_cm_data['observation_states']))
print(0.8)
...
'''np.sum(prim_cm_data['hidden_states'] == decoded_hidden_states_for_observed_states_of_prim_cm) / len(
